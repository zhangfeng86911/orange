 ...
 */
angular.module('orange').filter('underscoresToWords', function () {
...
angular.module('orange').filter('firstLetterUp', function() {
   return function (input) {
       input = input.toLowerCase();
 ...
 */
angular.module('orange').filter('arrayToHtmlList', ['$sce', function($sce) {
    return function(input) {
        var output = '';
 ...
 */
angular.module('orange').filter('arrayToList', function() {
    return function(input) {
        if (angular.isString(input)) {
            return input;
        }
